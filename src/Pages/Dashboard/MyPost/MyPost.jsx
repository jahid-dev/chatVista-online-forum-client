  ...
  return (
    <div className="container mx-auto mt-8">
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-collapse border-gray-300 table-auto">
          {/* Head */}
          ...
          <tbody>
            ...
            {posts.map((post, index) => (
              ...
              >
                ...
                <td className="py-2 px-4 border text-center align-middle">
                  <Link
                    to={`/dashboard/allComments/${post._id}`}
                    className="btn btn-sm text-black hover:bg-blue-700"
                  >
                    Comment
                  </Link>
                </td>
